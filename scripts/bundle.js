...
},{"spotify-api.js":40}],6:[function(require,module,exports){
...
},{"./adapters/http":7,"./adapters/xhr":7,"./core/enhanceError":17,"./helpers/normalizeHeaderName":30,"./utils":34,"_process":4}],22:[function(require,module,exports){
module.exports = {
  "version": "0.24.0"
};
...
},{"./structures/Album":52,"./structures/Artist":53,"./structures/Episode":54,"./structures/Playlist":56,"./structures/Show":57,"./structures/Track":58,"./structures/User":59}],36:[function(require,module,exports){
"use strict";
...
class Client {
    ...
    constructor(options) {
        ...
        if (typeof options.token == "string") {
            ...
            if (options.userAuthorizedToken) {
                ...
                (_b = options.onReady) === null || _b === void 0 ? void 0 : _b.call(options, this);
        }
        else if ('redirectURL' in options.token) {
            if (options.refreshToken)
                this.refreshMeta = options.token;
            this.auth.getUserToken(options.token)
                .then(async (context) => {
                var _a;
                if (options.refreshToken)
    ...
    fetch(url, options = {}) {
        return (0, axios_1.default)({
            ...
            else if (error.response.data.error.message == "Invalid access token" && this.refreshMeta)
...
},{"./Cache":35,"./Error":37,"./managers/Album":41,"./managers/Artist":42,"./managers/Auth":43,"./managers/Browse":44,"./managers/Episode":45,"./managers/Playlist":47,"./managers/Show":48,"./managers/Track":49,"./managers/User":50,"./managers/UserClient":51,"axios":6}],37:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"./Cache":35,"./Client":36,"./Error":37,"./Interface":38,"./Util":39,"./managers/Album":41,"./managers/Artist":42,"./managers/Auth":43,"./managers/Browse":44,"./managers/Episode":45,"./managers/Player":46,"./managers/Playlist":47,"./managers/Show":48,"./managers/Track":49,"./managers/User":50,"./managers/UserClient":51,"./structures/Album":52,"./structures/Artist":53,"./structures/Episode":54,"./structures/Player":55,"./structures/Playlist":56,"./structures/Show":57,"./structures/Track":58,"./structures/User":59}],41:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Cache":35}],42:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"axios":6,"buffer":2}],44:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Cache":35}],45:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Cache":35}],46:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class Player {
     ...
     */
    getCurrentPlayback(additionalTypes) {
        return this.client.fetch(`/me/player`, { params: { additional_types: additionalTypes } })
            .then(x => x ? (0, Player_1.createCurrentPlayback)(this.client, x) : null);
    }
    /**
     ...
     */
    getCurrentlyPlaying(additionalTypes) {
        return this.client.fetch(`/me/player/currently-playing`, { params: { additional_types: additionalTypes } })
            .then(x => x ? (0, Player_1.createCurrentlyPlaying)(this.client, x) : null);
    }
    /**
    ...
    getRecentlyPlayed(options = {}) {
        return this.client.fetch(`/me/player/recently-played`, { params: options }).then(x => (0, Player_1.createRecentlyPlayed)(this.client, x));
    }
    /**
     ...
     */
    getDevices() {
        return this.client.fetch(`/me/player/devices`).then(x => x.devices.map(Player_1.createDevice));
    }
    /**
     ...
     */
    async setShuffleState(state = true, deviceID) {
...
},{"../structures/Player":55}],47:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
class PlaylistManager {
    ...
    async reorderItems(id, options) {
        ...
        const fetchedData = await this.client.fetch(`/playlists/${id}/tracks`, {
            method: 'PUT',
            params: {
                uris: (_a = options.uris) === null || _a === void 0 ? void 0 : _a.join(','),
...
},{"../Cache":35,"../structures/Playlist":56}],48:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Cache":35}],49:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Cache":35}],50:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Cache":35}],51:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Cache":35,"../Error":37,"./Player":46}],52:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Cache":35,"../Util":39}],53:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Util":39}],54:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Cache":35,"../Util":39}],55:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Cache":35}],56:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Cache":35,"../Util":39,"./Episode":54,"./Track":58}],57:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.Show = void 0;
const Cache_1 = require("../Cache");
...
},{"../Cache":35,"../Util":39}],58:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{"../Cache":35,"../Util":39}],59:[function(require,module,exports){
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
exports.User = void 0;
const Util_1 = require("../Util");
